...
# 5.最新电影
@home.route('/movienew/<int:page>/',methods=['GET'])
@user_login_req
def movienew(page=None):
    if page == None:
        page = 1,
    page_data = Movie.query.order_by(
                Movie.addtime.asc()
    ...
    return render_template('home/movienew.html',page_data=page_data)

# 5.热门电影
@home.route('/moviehot/<int:page>/',methods=['GET'])
@user_login_req
def moviehot(page=None):
    if page == None:
        page = 1
    page_data = Movie.query.order_by(
                Movie.star.asc()
    ...
    page_data = page_data.paginate(page=page,per_page=10)
    print("page_data", page_data)
    return render_template('home/moviehot.html',page_data=page_data)


# 5.电影推荐
@home.route('/movierecommend/<int:page>/',methods=['GET'])
@user_login_req
def movierecommend(page=None):
    if page == None:
        page = 1
